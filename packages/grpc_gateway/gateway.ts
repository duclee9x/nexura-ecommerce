...
export const getUserGateway = async (id: string): Promise<GetUserResponse> => {
    return userService.getUser(id);
};

export const getBatchUsersGateway = async (userIds: string[]): Promise<GetBatchUsersResponse> => {
    return userService.getBatchUsers(userIds);
};
...
export const getOrderGateway = async (orderId: string): Promise<GetOrderResponse> => {
    return orderService.getOrder(orderId);
};

export const getOrdersForAdminGateway = async (userIds: string[]): Promise<GetOrdersForAdminResponse> => {
    return orderService.getOrdersForAdmin(userIds);
};
...
export const updateOrderStatusGateway = async (orderId: string, status: OrderStatus): Promise<UpdateOrderStatusResponse> => {
