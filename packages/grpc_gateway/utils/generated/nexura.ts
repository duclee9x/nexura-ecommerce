...
export function serviceNameFromJSON(object: any): ServiceName {
  switch (object) {
    ...
    case "PRODUCT_SERVICE":
      return ServiceName.PRODUCT_SERVICE;
    case 4:
...
export const UpdateOrderPaymentResponse: MessageFns<UpdateOrderPaymentResponse> = {
  encode(message: UpdateOrderPaymentResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    return writer;
  ...
  fromJSON(object: any): UpdateOrderPaymentResponse {
    return { success: isSet(object.success) ? globalThis.Boolean(object.success) : false };
  },

  toJSON(message: UpdateOrderPaymentResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
      obj.success = message.success;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateOrderPaymentResponse>, I>>(object: I): UpdateOrderPaymentResponse {
    const message = createBaseUpdateOrderPaymentResponse();
    message.success = object.success ?? false;
    return message;
  },
...
export const CreateOrderRequest: MessageFns<CreateOrderRequest> = {
  encode(message: CreateOrderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.paymentSubtotal !== 0) {
      writer.uint32(41).double(message.paymentSubtotal);
    }
    if (message.paymentTotal !== 0) {
      writer.uint32(49).double(message.paymentTotal);
    }
    if (message.shippingMethod !== "") {
      writer.uint32(58).string(message.shippingMethod);
    }
    if (message.shippingCost !== 0) {
      writer.uint32(65).double(message.shippingCost);
    }
    if (message.shippingAddress !== undefined) {
      ExtendedAddress.encode(message.shippingAddress, writer.uint32(74).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.paymentSubtotal = reader.double();
          continue;
        }
        case 6: {
          if (tag !== 49) {
          ...
          message.paymentTotal = reader.double();
          continue;
        }
        case 7: {
          if (tag !== 58) {
  ...
  fromJSON(object: any): CreateOrderRequest {
    return {
      ...
      paymentSubtotal: isSet(object.paymentSubtotal) ? globalThis.Number(object.paymentSubtotal) : 0,
      paymentTotal: isSet(object.paymentTotal) ? globalThis.Number(object.paymentTotal) : 0,
  ...
  toJSON(message: CreateOrderRequest): unknown {
    ...
    if (message.paymentSubtotal !== 0) {
      obj.paymentSubtotal = message.paymentSubtotal;
    }
    if (message.paymentTotal !== 0) {
      obj.paymentTotal = message.paymentTotal;
    }
    if (message.shippingMethod !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<CreateOrderRequest>, I>>(object: I): CreateOrderRequest {
    ...
    message.paymentSubtotal = object.paymentSubtotal ?? 0;
    message.paymentTotal = object.paymentTotal ?? 0;
...
export const AddressServiceService = {
  getCountries: {
    ...
    responseSerialize: (value: GetCountriesResponse): Buffer =>
      Buffer.from(GetCountriesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetCountriesResponse => GetCountriesResponse.decode(value),
  },
  getProvincesByCountry: {
    path: "/nexuraTelemetry.AddressService/GetProvincesByCountry",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetProvincesByCountryRequest): Buffer =>
      Buffer.from(GetProvincesByCountryRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetProvincesByCountryRequest => GetProvincesByCountryRequest.decode(value),
    responseSerialize: (value: GetProvincesResponse): Buffer =>
      Buffer.from(GetProvincesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetProvincesResponse => GetProvincesResponse.decode(value),
  },
  getDistrictsByProvince: {
    path: "/nexuraTelemetry.AddressService/GetDistrictsByProvince",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetDistrictsByProvinceRequest): Buffer =>
      Buffer.from(GetDistrictsByProvinceRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetDistrictsByProvinceRequest => GetDistrictsByProvinceRequest.decode(value),
    responseSerialize: (value: GetDistrictsResponse): Buffer =>
      Buffer.from(GetDistrictsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetDistrictsResponse => GetDistrictsResponse.decode(value),
  },
  getWardsByDistrict: {
    path: "/nexuraTelemetry.AddressService/GetWardsByDistrict",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetWardsByDistrictRequest): Buffer =>
      Buffer.from(GetWardsByDistrictRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetWardsByDistrictRequest => GetWardsByDistrictRequest.decode(value),
    responseSerialize: (value: GetWardsResponse): Buffer => Buffer.from(GetWardsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetWardsResponse => GetWardsResponse.decode(value),
  },
  addAddress: {
    path: "/nexuraTelemetry.AddressService/AddAddress",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: AddAddressRequest): Buffer => Buffer.from(AddAddressRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): AddAddressRequest => AddAddressRequest.decode(value),
  ...
  updateAddress: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateAddressRequest): Buffer => Buffer.from(UpdateAddressRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): UpdateAddressRequest => UpdateAddressRequest.decode(value),
    responseSerialize: (value: AddressResponse): Buffer => Buffer.from(AddressResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): AddressResponse => AddressResponse.decode(value),
  },
  deleteAddress: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteAddressRequest): Buffer => Buffer.from(DeleteAddressRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): DeleteAddressRequest => DeleteAddressRequest.decode(value),
    responseSerialize: (value: DeleteAddressResponse): Buffer =>
      Buffer.from(DeleteAddressResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): DeleteAddressResponse => DeleteAddressResponse.decode(value),
  },
  getAddresses: {
    path: "/nexuraTelemetry.AddressService/GetAddresses",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetAddressesRequest): Buffer => Buffer.from(GetAddressesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetAddressesRequest => GetAddressesRequest.decode(value),
    responseSerialize: (value: GetAddressesResponse): Buffer =>
      Buffer.from(GetAddressesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetAddressesResponse => GetAddressesResponse.decode(value),
  },
  getAddress: {
  ...
  getBatchAddresses: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetBatchAddressesRequest): Buffer =>
      Buffer.from(GetBatchAddressesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetBatchAddressesRequest => GetBatchAddressesRequest.decode(value),
    responseSerialize: (value: GetBatchAddressesResponse): Buffer =>
      Buffer.from(GetBatchAddressesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetBatchAddressesResponse => GetBatchAddressesResponse.decode(value),
  },
} as const;
...
export const UserServiceService = {
  getBatchUsers: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetBatchUsersRequest): Buffer => Buffer.from(GetBatchUsersRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetBatchUsersRequest => GetBatchUsersRequest.decode(value),
    responseSerialize: (value: GetBatchUsersResponse): Buffer =>
      Buffer.from(GetBatchUsersResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetBatchUsersResponse => GetBatchUsersResponse.decode(value),
  },
  getUser: {
  ...
  validateOtp: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ValidateOTPRequest): Buffer => Buffer.from(ValidateOTPRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ValidateOTPRequest => ValidateOTPRequest.decode(value),
    responseSerialize: (value: ValidateOTPResponse): Buffer => Buffer.from(ValidateOTPResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ValidateOTPResponse => ValidateOTPResponse.decode(value),
  },
  resetPassword: {
  ...
  verifyAccount: {
    ...
    responseSerialize: (value: VerifyAccountResponse): Buffer =>
      Buffer.from(VerifyAccountResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): VerifyAccountResponse => VerifyAccountResponse.decode(value),
  },
  updatePassword: {
  ...
  registerUserForAdmin: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RegisterUserForAdminRequest): Buffer =>
      Buffer.from(RegisterUserForAdminRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): RegisterUserForAdminRequest => RegisterUserForAdminRequest.decode(value),
    responseSerialize: (value: RegisterUserForAdminResponse): Buffer =>
      Buffer.from(RegisterUserForAdminResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): RegisterUserForAdminResponse => RegisterUserForAdminResponse.decode(value),
  },
} as const;
...
export const CartServiceService = {
  ...
  addItem: {
    ...
    responseSerialize: (value: AddItemResponse): Buffer => Buffer.from(AddItemResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): AddItemResponse => AddItemResponse.decode(value),
  },
  updateItem: {
    ...
    responseSerialize: (value: UpdateItemResponse): Buffer => Buffer.from(UpdateItemResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): UpdateItemResponse => UpdateItemResponse.decode(value),
  },
  removeItem: {
    path: "/nexuraTelemetry.CartService/RemoveItem",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RemoveItemRequest): Buffer => Buffer.from(RemoveItemRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): RemoveItemRequest => RemoveItemRequest.decode(value),
    responseSerialize: (value: RemoveItemResponse): Buffer => Buffer.from(RemoveItemResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): RemoveItemResponse => RemoveItemResponse.decode(value),
  },
  clearCart: {
  ...
  validateCart: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ValidateCartRequest): Buffer => Buffer.from(ValidateCartRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ValidateCartRequest => ValidateCartRequest.decode(value),
    responseSerialize: (value: ValidateCartResponse): Buffer =>
      Buffer.from(ValidateCartResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ValidateCartResponse => ValidateCartResponse.decode(value),
  },
} as const;
...
export const ProductServiceService = {
  createProduct: {
    path: "/nexuraTelemetry.ProductService/CreateProduct",
    requestStream: false,
    responseStream: false,
  ...
  updateProduct: {
    path: "/nexuraTelemetry.ProductService/UpdateProduct",
    requestStream: false,
    responseStream: false,
  ...
  deleteProduct: {
    path: "/nexuraTelemetry.ProductService/DeleteProduct",
    requestStream: false,
    responseStream: false,
  ...
  createVariant: {
    path: "/nexuraTelemetry.ProductService/CreateVariant",
    requestStream: false,
    responseStream: false,
  ...
  getProduct: {
    path: "/nexuraTelemetry.ProductService/GetProduct",
    requestStream: false,
    responseStream: false,
  ...
  listProducts: {
    path: "/nexuraTelemetry.ProductService/ListProducts",
    requestStream: false,
    responseStream: false,
  ...
  createBrand: {
    path: "/nexuraTelemetry.ProductService/CreateBrand",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateBrandRequest): Buffer => Buffer.from(CreateBrandRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): CreateBrandRequest => CreateBrandRequest.decode(value),
    responseSerialize: (value: CreateBrandResponse): Buffer => Buffer.from(CreateBrandResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): CreateBrandResponse => CreateBrandResponse.decode(value),
  },
  newBrand: {
    path: "/nexuraTelemetry.ProductService/NewBrand",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: NewBrandRequest): Buffer => Buffer.from(NewBrandRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): NewBrandRequest => NewBrandRequest.decode(value),
    responseSerialize: (value: NewBrandResponse): Buffer => Buffer.from(NewBrandResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): NewBrandResponse => NewBrandResponse.decode(value),
  },
  removeBrand: {
    path: "/nexuraTelemetry.ProductService/RemoveBrand",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RemoveBrandRequest): Buffer => Buffer.from(RemoveBrandRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): RemoveBrandRequest => RemoveBrandRequest.decode(value),
    responseSerialize: (value: RemoveBrandResponse): Buffer => Buffer.from(RemoveBrandResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): RemoveBrandResponse => RemoveBrandResponse.decode(value),
  },
  getAllBrand: {
    path: "/nexuraTelemetry.ProductService/GetAllBrand",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Empty): Buffer => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer): Empty => Empty.decode(value),
    responseSerialize: (value: GetAllBrandResponse): Buffer => Buffer.from(GetAllBrandResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetAllBrandResponse => GetAllBrandResponse.decode(value),
  },
  getVariantsForCart: {
    path: "/nexuraTelemetry.ProductService/GetVariantsForCart",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetVariantsForCartRequest): Buffer =>
      Buffer.from(GetVariantsForCartRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetVariantsForCartRequest => GetVariantsForCartRequest.decode(value),
    responseSerialize: (value: GetVariantsForCartResponse): Buffer =>
      Buffer.from(GetVariantsForCartResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetVariantsForCartResponse => GetVariantsForCartResponse.decode(value),
  },
  changeProductStatus: {
    path: "/nexuraTelemetry.ProductService/ChangeProductStatus",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ChangeProductStatusRequest): Buffer =>
      Buffer.from(ChangeProductStatusRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ChangeProductStatusRequest => ChangeProductStatusRequest.decode(value),
    responseSerialize: (value: ChangeProductStatusResponse): Buffer =>
      Buffer.from(ChangeProductStatusResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ChangeProductStatusResponse => ChangeProductStatusResponse.decode(value),
  },
  createCategory: {
    path: "/nexuraTelemetry.ProductService/CreateCategory",
    requestStream: false,
    responseStream: false,
    ...
    responseSerialize: (value: CreateCategoryResponse): Buffer =>
      Buffer.from(CreateCategoryResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): CreateCategoryResponse => CreateCategoryResponse.decode(value),
  },
  updateCategory: {
    path: "/nexuraTelemetry.ProductService/UpdateCategory",
    requestStream: false,
    responseStream: false,
    ...
    responseSerialize: (value: UpdateCategoryResponse): Buffer =>
      Buffer.from(UpdateCategoryResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): UpdateCategoryResponse => UpdateCategoryResponse.decode(value),
  },
  deleteCategory: {
    path: "/nexuraTelemetry.ProductService/DeleteCategory",
    requestStream: false,
    responseStream: false,
  ...
  getAllCategory: {
    path: "/nexuraTelemetry.ProductService/GetAllCategory",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Empty): Buffer => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer): Empty => Empty.decode(value),
    responseSerialize: (value: GetAllCategoryResponse): Buffer =>
      Buffer.from(GetAllCategoryResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetAllCategoryResponse => GetAllCategoryResponse.decode(value),
  },
  getProductAttributes: {
    path: "/nexuraTelemetry.ProductService/GetProductAttributes",
    requestStream: false,
    responseStream: false,
  ...
  updateProductAttributes: {
    path: "/nexuraTelemetry.ProductService/UpdateProductAttributes",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateProductAttributesRequest): Buffer =>
      Buffer.from(UpdateProductAttributesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): UpdateProductAttributesRequest => UpdateProductAttributesRequest.decode(value),
    responseSerialize: (value: UpdateProductAttributesResponse): Buffer =>
      Buffer.from(UpdateProductAttributesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): UpdateProductAttributesResponse =>
      UpdateProductAttributesResponse.decode(value),
  },
  deleteProductAttributes: {
    path: "/nexuraTelemetry.ProductService/DeleteProductAttributes",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteProductAttributesRequest): Buffer =>
      Buffer.from(DeleteProductAttributesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): DeleteProductAttributesRequest => DeleteProductAttributesRequest.decode(value),
    responseSerialize: (value: DeleteProductAttributesResponse): Buffer =>
      Buffer.from(DeleteProductAttributesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): DeleteProductAttributesResponse =>
      DeleteProductAttributesResponse.decode(value),
  },
  createProductAttribute: {
    path: "/nexuraTelemetry.ProductService/CreateProductAttribute",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateProductAttributeRequest): Buffer =>
      Buffer.from(CreateProductAttributeRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): CreateProductAttributeRequest => CreateProductAttributeRequest.decode(value),
    responseSerialize: (value: CreateProductAttributeResponse): Buffer =>
      Buffer.from(CreateProductAttributeResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): CreateProductAttributeResponse =>
      CreateProductAttributeResponse.decode(value),
  },
  getWarehouses: {
    path: "/nexuraTelemetry.ProductService/GetWarehouses",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Empty): Buffer => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer): Empty => Empty.decode(value),
    responseSerialize: (value: GetWarehousesResponse): Buffer =>
      Buffer.from(GetWarehousesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetWarehousesResponse => GetWarehousesResponse.decode(value),
  },
  validateAndReserve: {
    path: "/nexuraTelemetry.ProductService/ValidateAndReserve",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ValidateAndReserveRequest): Buffer =>
      Buffer.from(ValidateAndReserveRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ValidateAndReserveRequest => ValidateAndReserveRequest.decode(value),
    responseSerialize: (value: ValidateAndReserveResponse): Buffer =>
      Buffer.from(ValidateAndReserveResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ValidateAndReserveResponse => ValidateAndReserveResponse.decode(value),
  },
  releaseReservation: {
    path: "/nexuraTelemetry.ProductService/ReleaseReservation",
    requestStream: false,
    responseStream: false,
  ...
  commitReservation: {
    path: "/nexuraTelemetry.ProductService/CommitReservation",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CommitReservationRequest): Buffer =>
      Buffer.from(CommitReservationRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): CommitReservationRequest => CommitReservationRequest.decode(value),
    responseSerialize: (value: CommitReservationResponse): Buffer =>
      Buffer.from(CommitReservationResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): CommitReservationResponse => CommitReservationResponse.decode(value),
  },
  addWishlist: {
    path: "/nexuraTelemetry.ProductService/AddWishlist",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: AddWishlistRequest): Buffer => Buffer.from(AddWishlistRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): AddWishlistRequest => AddWishlistRequest.decode(value),
    responseSerialize: (value: AddWishlistResponse): Buffer => Buffer.from(AddWishlistResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): AddWishlistResponse => AddWishlistResponse.decode(value),
  },
  getWishlist: {
    path: "/nexuraTelemetry.ProductService/GetWishlist",
    requestStream: false,
    responseStream: false,
  ...
  removeWishlist: {
    path: "/nexuraTelemetry.ProductService/RemoveWishlist",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RemoveWishlistRequest): Buffer =>
      Buffer.from(RemoveWishlistRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): RemoveWishlistRequest => RemoveWishlistRequest.decode(value),
    responseSerialize: (value: RemoveWishlistResponse): Buffer =>
      Buffer.from(RemoveWishlistResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): RemoveWishlistResponse => RemoveWishlistResponse.decode(value),
  },
} as const;
...
export const ProductServiceClient = makeGenericClientConstructor(
  ...
  "nexuraTelemetry.ProductService",
) as unknown as {
...
export const EmailServiceService = {
  ...
  sendOtpResetPassword: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SendOTPResetPasswordRequest): Buffer =>
      Buffer.from(SendOTPResetPasswordRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): SendOTPResetPasswordRequest => SendOTPResetPasswordRequest.decode(value),
    responseSerialize: (value: SendOTPResetPasswordResponse): Buffer =>
      Buffer.from(SendOTPResetPasswordResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): SendOTPResetPasswordResponse => SendOTPResetPasswordResponse.decode(value),
  },
  sendWelcomeEmail: {
    path: "/nexuraTelemetry.EmailService/SendWelcomeEmail",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SendWelcomeEmailRequest): Buffer =>
      Buffer.from(SendWelcomeEmailRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): SendWelcomeEmailRequest => SendWelcomeEmailRequest.decode(value),
    responseSerialize: (value: SendWelcomeEmailResponse): Buffer =>
      Buffer.from(SendWelcomeEmailResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): SendWelcomeEmailResponse => SendWelcomeEmailResponse.decode(value),
  },
  sendNewUserByAdmin: {
    path: "/nexuraTelemetry.EmailService/SendNewUserByAdmin",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SendNewUserByAdminRequest): Buffer =>
      Buffer.from(SendNewUserByAdminRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): SendNewUserByAdminRequest => SendNewUserByAdminRequest.decode(value),
    responseSerialize: (value: SendNewUserByAdminResponse): Buffer =>
      Buffer.from(SendNewUserByAdminResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): SendNewUserByAdminResponse => SendNewUserByAdminResponse.decode(value),
  },
} as const;
...
export const OrderServiceService = {
  ...
  getOrderStatus: {
    ...
    responseSerialize: (value: GetOrderStatusResponse): Buffer =>
      Buffer.from(GetOrderStatusResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetOrderStatusResponse => GetOrderStatusResponse.decode(value),
  },
  getOrder: {
  ...
  getOrdersForAdmin: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetOrdersForAdminRequest): Buffer =>
      Buffer.from(GetOrdersForAdminRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetOrdersForAdminRequest => GetOrdersForAdminRequest.decode(value),
    responseSerialize: (value: GetOrdersForAdminResponse): Buffer =>
      Buffer.from(GetOrdersForAdminResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetOrdersForAdminResponse => GetOrdersForAdminResponse.decode(value),
  },
  cancelOrder: {
  ...
  updateOrderPayment: {
    path: "/nexuraTelemetry.OrderService/UpdateOrderPayment",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateOrderPaymentRequest): Buffer =>
      Buffer.from(UpdateOrderPaymentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): UpdateOrderPaymentRequest => UpdateOrderPaymentRequest.decode(value),
    responseSerialize: (value: UpdateOrderPaymentResponse): Buffer =>
      Buffer.from(UpdateOrderPaymentResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): UpdateOrderPaymentResponse => UpdateOrderPaymentResponse.decode(value),
  },
  listOrders: {
  ...
  addOrderNote: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: AddOrderNoteRequest): Buffer => Buffer.from(AddOrderNoteRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): AddOrderNoteRequest => AddOrderNoteRequest.decode(value),
    responseSerialize: (value: AddOrderNoteResponse): Buffer =>
      Buffer.from(AddOrderNoteResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): AddOrderNoteResponse => AddOrderNoteResponse.decode(value),
  },
  deleteOrderNote: {
    path: "/nexuraTelemetry.OrderService/DeleteOrderNote",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteOrderNoteRequest): Buffer =>
      Buffer.from(DeleteOrderNoteRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): DeleteOrderNoteRequest => DeleteOrderNoteRequest.decode(value),
    responseSerialize: (value: DeleteOrderNoteResponse): Buffer =>
      Buffer.from(DeleteOrderNoteResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): DeleteOrderNoteResponse => DeleteOrderNoteResponse.decode(value),
  },
  updateTrackingNumber: {
    path: "/nexuraTelemetry.OrderService/UpdateTrackingNumber",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateTrackingNumberRequest): Buffer =>
      Buffer.from(UpdateTrackingNumberRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): UpdateTrackingNumberRequest => UpdateTrackingNumberRequest.decode(value),
    responseSerialize: (value: UpdateTrackingNumberResponse): Buffer =>
      Buffer.from(UpdateTrackingNumberResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): UpdateTrackingNumberResponse => UpdateTrackingNumberResponse.decode(value),
  },
  listAllOrders: {
    ...
    requestSerialize: (value: Empty): Buffer => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer): Empty => Empty.decode(value),
    responseSerialize: (value: ListAllOrdersResponse): Buffer =>
      Buffer.from(ListAllOrdersResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ListAllOrdersResponse => ListAllOrdersResponse.decode(value),
  },
} as const;
...
export interface OrderServiceServer extends UntypedServiceImplementation {
  ...
  updateOrderPayment: handleUnaryCall<UpdateOrderPaymentRequest, UpdateOrderPaymentResponse>;
...
export interface OrderServiceClient extends Client {
  ...
  updateOrderPayment(
    ...
    callback: (error: ServiceError | null, response: UpdateOrderPaymentResponse) => void,
  ): ClientUnaryCall;
  updateOrderPayment(
    request: UpdateOrderPaymentRequest,
    metadata: Metadata,
...
export const PaymentServiceService = {
  ...
  getBatchPayments: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetBatchPaymentsRequest): Buffer =>
      Buffer.from(GetBatchPaymentsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetBatchPaymentsRequest => GetBatchPaymentsRequest.decode(value),
    responseSerialize: (value: GetBatchPaymentsResponse): Buffer =>
      Buffer.from(GetBatchPaymentsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetBatchPaymentsResponse => GetBatchPaymentsResponse.decode(value),
  },
} as const;
...
export const OrchestratorServiceService = {
  createSagaOrder: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateSagaOrderRequest): Buffer =>
      Buffer.from(CreateSagaOrderRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): CreateSagaOrderRequest => CreateSagaOrderRequest.decode(value),
    responseSerialize: (value: CreateSagaOrderResponse): Buffer =>
      Buffer.from(CreateSagaOrderResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): CreateSagaOrderResponse => CreateSagaOrderResponse.decode(value),
  },
} as const;
