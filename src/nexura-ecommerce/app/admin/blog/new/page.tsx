...
export default function NewBlogPostPage() {
  ...
  const handleSave = (status?: string) => {
    ...
    if (status === "published" || (status === "scheduled" && publishDate)) {
      ...
      updatedPost.datePublished = publishDateTime.toISOString()
    }
        ...
        <main className="flex-1 p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <h1 className="text-3xl font-bold dark:text-white">Create New Post</h1>
            </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-6">
                    ...
                    <TabsContent value="media" className="pt-4">
                      <ImageUploader currentImage={post.featuredImage} onImageSelected={handleFeaturedImageChange} />
                    </TabsContent>
                  </Tabs>
                </CardContent>
              </Card>
                  ...
                  {isScheduled && publishDate && (
                    <div className="flex items-center mt-4 p-3 bg-muted rounded-md">
                      ...
                      <span className="text-sm">
                        Scheduled to publish on {format(publishDate, "PPP")}
