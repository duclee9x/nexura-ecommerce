...
const initialBlogPosts: BlogPost[] = [
  {
    ...
    featuredImage: "/placeholder.svg?height=600&width=1200&text=Backpack+Guide",
    categories: ["guides", "products"],
    tags: ["backpacks", "travel", "gear"],
    status: "published",
    dateCreated: "2023-03-10T09:30:00",
    datePublished: "2023-03-15T10:00:00",
    dateModified: "2023-03-15T10:00:00",
  ...
  },
  {
    ...
    featuredImage: "/placeholder.svg?height=600&width=1200&text=Travel+Accessories",
    categories: ["travel", "products"],
    tags: ["accessories", "travel", "essentials"],
    status: "published",
    dateCreated: "2023-02-20T14:45:00",
    datePublished: "2023-02-25T09:00:00",
    dateModified: "2023-02-25T09:00:00",
    seoTitle: "5 Essential Travel Accessories for Your Next Adventure | NEXURA",
    seoDescription:
      "Prepare for your next journey with these must-have travel accessories that combine style, functionality, and convenience.",
  },
  {
    ...
    featuredImage: "/placeholder.svg?height=600&width=1200&text=Packing+Tips",
    categories: ["guides", "travel"],
    tags: ["packing", "travel", "organization"],
    status: "published",
    dateCreated: "2023-01-15T11:20:00",
    datePublished: "2023-01-20T10:30:00",
    dateModified: "2023-01-20T10:30:00",
    seoTitle: "How to Pack Efficiently for a Weekend Getaway | NEXURA",
    seoDescription: "Master the art of packing light with our expert tips for organizing your weekend bag efficiently.",
  },
  {
    id: 4,
    ...
    featuredImage: "/placeholder.svg?height=600&width=1200&text=Backpack+History",
    categories: ["history", "fashion"],
    tags: ["backpacks", "fashion", "history"],
    status: "draft",
    dateCreated: "2023-03-18T15:10:00",
    datePublished: "",
    dateModified: "2023-03-18T15:10:00",
    seoTitle: "The History of Backpacks: From Practical to Fashionable | NEXURA",
    seoDescription:
      "Explore the fascinating evolution of backpacks from simple utility items to fashion statements and everyday essentials.",
  },
  {
    ...
    featuredImage: "/placeholder.svg?height=600&width=1200&text=Sustainable+Materials",
    categories: ["sustainability", "manufacturing"],
    tags: ["eco-friendly", "materials", "sustainability"],
    status: "draft",
    dateCreated: "2023-03-05T09:45:00",
    datePublished: "",
    dateModified: "2023-03-05T09:45:00",
    seoTitle: "Sustainable Materials in Modern Bag Manufacturing | NEXURA",
    seoDescription:
      "Discover how eco-friendly materials are revolutionizing the bag industry and creating a more sustainable future.",
  },
]
...
export default function BlogManagementPage() {
  ...
  const sortedPosts = [...filteredPosts].sort((a, b) => {
    if (sortField === "title") {
      ...
      if (!a.datePublished) return sortDirection === "asc" ? -1 : 1
      if (!b.datePublished) return sortDirection === "asc" ? 1 : -1
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>
                        <div className="flex items-center cursor-pointer" onClick={() => handleSort("datePublished")}>
                          Published
                          <ArrowUpDown className="ml-2 h-4 w-4" />
                        </div>
                      </TableHead>
