                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => handleGeneralSelectChange("storeLanguage", value)}
                      >
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      id="seoDescription" 
                      placeholder="Discover premium quality backpacks, bags, and accessories at NEXURA. Free shipping on orders over $100."
                      rows={3}
                    />
                    <p className="text-xs text-muted-foreground">
