...
export const addItem = async (call: ServerUnaryCall<AddItemRequest, AddItemResponse>, callback: sendUnaryData<AddItemResponse>) => {
    try {
      const { userId, productId, variantId, quantity, image, currencyCode } = call.request
