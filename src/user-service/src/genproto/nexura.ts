...
function createBaseUserResponse(): UserResponse {
  return { id: 0, name: "", email: "", createdAt: "", updatedAt: "" };
}
...
export interface UserServiceServer extends UntypedServiceImplementation {
  ...
  registerUser: handleUnaryCall<RegisterUserRequest, UserResponse>;
...
export const ProductCatalogServiceService = {
  ...
  searchProducts: {
    path: "/nexuraTelemetry.ProductCatalogService/SearchProducts",
    requestStream: false,
    responseStream: false,
