...
export const mockTShirtVariants: ProductVariant[] = [
  ...
  },
  {
    ...
    images:    [{ id: "img-5", url: "https://picsum.photos/id/5/500/500", isMain: true },],
    isDefault: false,
    status:    "active",
  },
  {
  ...
  // Black polyester variants
  {
    ...
    images:    [{ id: "img-7", url: "https://picsum.photos/id/7/500/500", isMain: true },],
    isDefault: false,
    status:    "active",
  },
  {
    ...
    images:    [{ id: "img-8", url: "https://picsum.photos/id/8/500/500", isMain: true },],
    isDefault: false,
    status:    "active",
  },
]
...
export const mockProducts: Product[] = [
  {
    ...
    attributes: [
      "attr-color", "attr-size", "attr-material", "attr-style"
    ],
